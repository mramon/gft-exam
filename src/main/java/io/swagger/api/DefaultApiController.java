...
import io.swagger.model.CustomersData;
...
public class DefaultApiController implements DefaultApi {
    ...
    public ResponseEntity<CustomersData> rootGet(@ApiParam(value = "Mime type request expected" ,required=true) 
												 ...
												 String authorization,@ApiParam(value = "Santander global ID" ,required=true) 
												 @RequestHeader(value="x-santander-global-id", required=true) String xSantanderGlobalId,
												 @ApiParam(value = "Customer ID") @Valid @RequestParam(value = "customer_id", required = false) String customerId,
												 @ApiParam(value = "Document number") @Valid
												 @RequestParam(value = "document_number", required = false) String documentNumber,
												 @ApiParam(value = "Company name") @Valid 
												 @RequestParam(value = "company_name", required = false) String companyName,
												 @ApiParam(value = "Company name") @Valid @RequestParam(value = "account_number", required = false) String accountNumber,
												 @ApiParam(value = "Name") @Valid @RequestParam(value = "name", required = false) String name,
												 @ApiParam(value = "Paternal Name") @Valid 
												 @RequestParam(value = "paternal_name", required = false) String paternalName,
												 @ApiParam(value = "Maternal Name") @Valid 
